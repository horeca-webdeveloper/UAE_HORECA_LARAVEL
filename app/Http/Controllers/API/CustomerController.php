...
//         $customer->notify(new ConfirmEmailNotification());

//         return response()->json(['message' => 'User registered successfully! Please check your email to confirm.', 'user' => $customer], 201);
//     } catch (\Exception $e) {
//         \Log::error('Error registering user: ' . $e->getMessage());
//         return response()->json(['error' => 'Failed to register user'], 500);
//     }
