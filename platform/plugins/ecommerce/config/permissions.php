...
return [
   ...
   [
    ...
    'flag' => 'ecommerce::partials.import-product-images.index',
    'parent_flag' => 'plugins.ecommerce',
],
    /**
     * Products
    ...
    //  [
    //     'name' => 'Edit Content', // New Permission for Content Edit
    //     'flag' => 'ecommerce.products.content',
    //     'parent_flag' => 'plugins.ecommerce',
    // ],
    // [
    //     'name' => 'Update',
    //     'flag' => 'ecommerce.product-products.content',
    //     'parent_flag' => 'ecommerce.product-content.index',
    // ],
    ...
    [
        'name' => 'Product type',
        'flag' => 'product-types.index',
        'parent_flag' => 'plugins.ecommerce',
    ],
    [
        'name' => 'Create',
        'flag' => 'product-types.create',
        'parent_flag' => 'product-types.index',
    ],
    [
        'name' => 'Edit',
        'flag' => 'product-types.edit',
        'parent_flag' => 'product-types.index',
    ],
    [
        'name' => 'Delete',
        'flag' => 'product-types.destroy',
        'parent_flag' => 'product-types.index',
    ],
    ...
    [
        'name' => 'Import Prices',
        'flag' => 'ecommerce.product-prices.import.index',
        'parent_flag' => 'tools.data-synchronize',
    ],
    ...
    [
        'name' => 'Import Images',
        'flag' => 'ecommerce.product-images.import.index',
        'parent_flag' => 'tools.data-synchronize',
    ],
