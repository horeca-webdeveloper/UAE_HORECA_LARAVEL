...
class EcommerceServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        SlugHelper::registerModule(ProductTag::class, 'Product Type');
        ...
        SlugHelper::setPrefix(ProductTypes::class, 'product-types', true);
        ...
        if (defined('LANGUAGE_MODULE_SCREEN_NAME') && defined('LANGUAGE_ADVANCED_MODULE_SCREEN_NAME')) {
            ...
            LanguageAdvancedManager::registerModule(ProductTypes::class, [
                'name',
            ]);
        ...
        DashboardMenu::beforeRetrieving(function () {
            DashboardMenu::make()
                ...
                ->registerItem([
                    ...
                    'priority' => 300,
                    'parent_id' => 'cms-plugins-ecommerce::partials', // Assuming you have a parent item
                ...
                ->registerItem([
                    'id' => 'cms-plugins-product-types',
                    'priority' => 300,
                    'parent_id' => 'cms-plugins-ecommerce',
                    'name' => 'plugins/ecommerce::product-types.name',
                    'icon' => 'ti ti-tag',
                    'url' => fn () => route('product-types.index'),
                    'permissions' => ['product-types.index'],
                ])

                ->registerItem([
                    'id' => 'cms-plugins-category-product-filter',
                    'priority' => 400,
                    'parent_id' => 'cms-plugins-ecommerce',
