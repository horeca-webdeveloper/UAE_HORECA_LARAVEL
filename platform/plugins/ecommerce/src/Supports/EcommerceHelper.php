...
class EcommerceHelper
{
    ...
    public function isEnabledFilterProductsByProductTypes(): bool
    {
        return (bool) get_ecommerce_setting('enable_filter_products_by_producttypes', true);
    }
    ...
    public function producttypesForFilter(array $categoryIds = []): Collection
    {
        if (! $this->isEnabledFilterProductsByProductTypes()) {
            return collect();
        }
